...
try {
	...
	$sql = "select ORD_NO,CUS_NO,CUS_NAME,CUS_TEL,CUS_ADD,TIME,o.SHIPPING,TOTAL,o.STATE,o.COUPON,e.PARM,d.DEL_FEE 
	from ord o join event e on o.COUPON=e.COUPON
			   join delivery d on o.SHIPPING=d.SHIPPING
			    where CUS_NO = {$cus_NO}";
